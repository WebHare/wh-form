...
, submittedToNextPage:function(opts)
  {
    var nextpageevent = new legacybase.Event;
    ...
    if(!instanceOf(nextpageevent.nextpage, pagemgr.PageBase))
    {
    ...
    //ADDME $wh.track("form","next",this.pagemgr.getCurrentPage().node);
  }
});
